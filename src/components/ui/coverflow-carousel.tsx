    ...
    >
          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  "absolute left-1/2 top-0 aspect-square overflow-hidden rounded-2xl bg-brand-deep shadow-xl will-change-transform border border-gold/20",
                  cardClassName,
                )}
        ...
        {showNavigation && (
          <>
            <button
              ...
              onClick={() => nudge(-1)}
              className="absolute left-4 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-brand-deep/80 p-3 text-gold border border-gold/30 backdrop-blur-md transition hover:bg-gold hover:text-brand-deep"
            >
            ...
            <button
              ...
              onClick={() => nudge(1)}
              className="absolute right-4 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-brand-deep/80 p-3 text-gold border border-gold/30 backdrop-blur-md transition hover:bg-gold hover:text-brand-deep"
            >
      ...
      {showCaption && active?.title && (
        ...
        >
          ...
          {active.subtitle && (
            <p className="mt-1 text-sm font-medium text-brand-deep/60">
              {active.subtitle}
            </p>
          )}
        </div>
